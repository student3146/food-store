...
function calc() {
  ...
  function getDenamicInformation(selector) {
  ...
  getDenamicInformation("#height");
  getDenamicInformation("#weight");
  getDenamicInformation("#age");
}
...
function tabs(
  ...
  const butTop = document.querySelector(tabsButTop);
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])(".timer", "2023-06-22");
